...
test_images = ['1.jpg', '2.jpg', '3.jpg', '4.jpg', '5.jpg', '6.jpg', '7.jpg', '8.jpg', '9.jpg', '10.jpg']

#for count, image_path in enumerate(sys.argv):
for image_path in test_images:
    """
    if count is 0:
        continue
    else:
        filename = dir_path + '\\test_data\\' + image_path
    ...
    print("[    cat        dog    ]: image {}".format(image_path))
    print(result) 
    print('')
